...
f1 = open(time.strftime("%d:%m") + "_" + time.strftime("%H:%M:%S")+'_logfile.txt', 'w')
sys.stdout = f1
...
parser.add_argument("--state_path", type=str, default='/data/rosa/e-SNLI/pretrained/state_dict_best_devppl__devPPL6.082__epoch_19_model.pt')
parser.add_argument("--eval_batch_size", type=int, default=16) #change size from 32 to 16

parser.add_argument("--directory_expl_to_labels", type=str, default='')
parser.add_argument("--state_path_expl_to_labels", type=str, default='/data/rosa/e-SNLI/pretrained/state_dict_best_devacc__devACC96.780__epoch_12_model.pt')
...
params.esnli_path = '/data/rosa/e-SNLI-3/dataset/'
